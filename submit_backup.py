...
# QCD configs
from wprime_plus_b.selections.qcd_hadronic.bjet_config import signal_bjet_selection
from wprime_plus_b.selections.qcd_hadronic.cases_top_tagger_config import signal_cases_selection
from wprime_plus_b.selections.qcd_hadronic.electron_config import signal_electron_selection
from wprime_plus_b.selections.qcd_hadronic.fatjet_config import signal_fatjet_selection
from wprime_plus_b.selections.qcd_hadronic.general_config import signal_cross_cleaning_selection, signal_trigger_selection
from wprime_plus_b.selections.qcd_hadronic.jet_config import signal_jet_selection
from wprime_plus_b.selections.qcd_hadronic.met_config import signal_met_selection
from wprime_plus_b.selections.qcd_hadronic.muon_config import signal_muon_selection
from wprime_plus_b.selections.qcd_hadronic.tau_config import signal_tau_selection
from wprime_plus_b.selections.qcd_hadronic.wjet_config import signal_wjet_selection
    ...
    for sample, fileset_path in filesets.items():
        ...
        if "metadata" in out[sample]:
            ...
            if args["processor"] in ["top_tagger"]:
                metadata.update({"sumw_no_ttboost": float(output_metadata["sumw_no_ttboost"])})

            # save metadata
            if args["processor"] in ["ttbar", "ztoll", "top_tagger", "signal", "wjets", "qcd_abcd", "qcd_hadronic"]:
