            ...
            for region_name, region_mask in region_selection_map.items():
                ...
                if nevents_after == 0:
                    if region_name == "nominal":
                        ...
                        output["metadata"][f"cutflow_{region_name}"][f"failing_top_tagger"] = ak.sum(weights_container.weight()[region_mask])
                    ...
                    if region_name == "nominal":
                        ...
                        output["metadata"][f"cutflow_{region_name}"][f"failing_top_tagger"] = ak.sum(weights_container.weight()[region_mask][mask_top])
