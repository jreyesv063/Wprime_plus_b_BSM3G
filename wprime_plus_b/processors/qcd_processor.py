...
from wprime_plus_b.selections.qcd_hadronic.delta_phi_jet_met_selection import select_good_delta_phi_jet_met
...
class QCDProccessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        # deltaphi_cut cut
        # --------------------------  
        delta_phi_cut = qcd_hadronic_met_selection[self.channel][self.lepton_flavor]["delta_phi_jet_met"]
        invert_delta_phi = qcd_hadronic_met_selection[self.channel][self.lepton_flavor]["invert_delta_phi"]
