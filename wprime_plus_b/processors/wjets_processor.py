...
# Utils
from wprime_plus_b.processors.utils.analysis_utils import delta_r_mask, normalize, output_metadata, fill_cutflow # histograms_output_syst
...
class WjetsProccessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        if self.run_systematics and self.is_mc:
            ...
            syst_var.get_syst_variation_mask(table_name = "cutflow", nworkers = self.criteria["top_tagger"][self.lepton_flavor]["nworkers"])
