    ...
    for sample, fileset_path in filesets.items():
        ...
        if "metadata" in out[sample]:
           ...
           # save top tagger selectios in qcd CR (hadronic channel)
                ...
                selections = {
                    "electron_selection": qcd_hadronic_electron_selection[
                        args["lepton_flavor"]
                        ],
                    "muon_selection": qcd_hadronic_muon_selection[
                        args["lepton_flavor"]
                        ],
                    "tau_selection": qcd_hadronic_tau_selection[
                        args["lepton_flavor"]
                        ],
                    "bjet_selection": qcd_hadronic_bjet_selection[
                        args["lepton_flavor"]
                        ],
                    "jet_selection": qcd_hadronic_jet_selection[
                        args["lepton_flavor"]
                        ],
                    "fatjet_selection": qcd_hadronic_fatjet_selection[
                        args["lepton_flavor"]
                        ],
                    "wjet_selection": qcd_hadronic_wjet_selection[
                        args["lepton_flavor"]
                        ],
                    "cross_cleaning_selection": qcd_hadronic_cross_cleaning_selection[
                        args["lepton_flavor"]
                        ],
                    "trigger_selection": qcd_hadronic_trigger_selection[
                        args["lepton_flavor"]
                        ],
                    "met_selection": qcd_hadronic_met_selection[
                        args["lepton_flavor"]
                        ],
                    "trigger_selection": qcd_hadronic_trigger_selection[
                        args["lepton_flavor"]
                        ],
                    "top_tagger_cases": qcd_hadronic_cases_selection[
                        args["lepton_flavor"]
                        ],
                }
                metadata.update({"selections": selections})
